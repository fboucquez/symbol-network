...
export class NetworkGenesisService {
    ...
    public async generateNemesis({ regenerate, composeUser, password }: GenerateNemesisParams): Promise<string> {
        ...
        BootstrapUtils.deleteFolder(this.logger, nemesisTargetFolder);
        BootstrapUtils.deleteFolder(this.logger, nodesFolder);
        BootstrapUtils.deleteFolder(this.logger, zipFolder);
        this.logger.info('');
