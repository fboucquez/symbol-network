...
import { BootstrapUtils, KeyName, Password, VotingKeyAccount, VotingUtils } from 'symbol-bootstrap';
...
export class LocalFileKeyStore implements KeyStore {
    ...
    async getVotingKeyFile(
        ...
        const privateFileContent = await votingUtils.createVotingFile(votingAccount.privateKey, votingFile.startEpoch, votingFile.endEpoch);
