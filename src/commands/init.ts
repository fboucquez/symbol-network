...
import { NetworkUtils } from '../';
import { InitFromFileService, InitService, NetworkCommandUtils } from '../utils';
...
`;
    ...
    public async run(): Promise<void> {
        ...
        const service = existsSync(NetworkUtils.NETWORK_INPUT_FILE)
            ? new InitFromFileService(logger, workingDir, flags)
            : new InitService(logger, workingDir, flags);
